...
static const key_map_t key_map[] = {  
  ...
  { AKEYCODE_BACK,       0, KEYPRESS_RELEASE,  0, ACTION_NAV_BACK },
  ...
  { AKEYCODE_HOME,        0, KEYPRESS_SHORT,  0, ACTION_HOME },
  { AKEYCODE_BACK,        0, KEYPRESS_LONG,  0, ACTION_HOME },
  
  // -- Media Keys --
  { AKEYCODE_MEDIA_PLAY_PAUSE, 0, KEYPRESS_SHORT, 0, ACTION_PLAYPAUSE },
  { AKEYCODE_MEDIA_PLAY, 0, KEYPRESS_SHORT, 0, ACTION_PLAYPAUSE },
  { AKEYCODE_MEDIA_PAUSE,      0, KEYPRESS_SHORT, 0, ACTION_PLAYPAUSE },
  ...
  { AKEYCODE_MEDIA_PREVIOUS,0,KEYPRESS_SHORT, 0, ACTION_SKIP_BACKWARD },
  { AKEYCODE_MEDIA_NEXT,0,KEYPRESS_SHORT, 0, ACTION_SKIP_FORWARD },
